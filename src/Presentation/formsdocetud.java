...
public class formsdocetud extends JFrame{
		...
		private Controleur controleur;
		 ...
		 public  formsdocetud(Controleur controleur,Integer id_etape ,Integer id_projet){
		...
		private void initialiser( Controleur controleur) {
			    ...
			    diposer_par_etud=new JLabel("diposer par etudient");
		...
		private void executer() {
						...
						new ActionListener() {
							...
							public void actionPerformed(ActionEvent e) {
						        ...
						        if (com.equals("parcourir")) {
						            ...
						            String src="";
						            if(jc.getSelectedItem()=="rapport") {
						            dest = "C:\\Users\\user\\Documents\\document_rapport";
						            }
				...
				diposer.addActionListener(
						new ActionListener() {
							...
							public void actionPerformed(ActionEvent e) {
								   try {
									controleur.diposerdocumentbyetd(textnom_doc.getText(),jc.getSelectedItem().toString(),id_etape,id_projet,textmotcle.getText(),diposer_par_etud.getText());
