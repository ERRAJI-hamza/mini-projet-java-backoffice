...
public class formulaireDr extends JFrame{
		  ...
		  private JTextField tdate_debut;
	 	  ...
	 	  private String s1;
	 	  private String s[]={"3 ans" , "6 ans"};
	 	  
	 	public formulaireDr(Controleur controleur) {
	 	...
	 	private void initialiser( Controleur controleur) {
			...
			tdate_debut=new JTextField("octobre");
						...
						new ActionListener() {
							...
							public void actionPerformed(ActionEvent e) {
								try {
									...
									controleur.fnprjdr(tdate_debut.getText(),s1,str,k);}
